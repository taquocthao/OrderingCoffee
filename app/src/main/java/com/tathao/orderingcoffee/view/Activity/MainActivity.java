...
import com.tathao.orderingcoffee.model.entity.User;
...
import com.tathao.orderingcoffee.view.Fragment.CheckInPage;
...
//            getFragmentManager().popBackStack();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            addFragment(orderHistory, getString(R.string.recent_order));
...
//            ).executeAsync();
            ...
            addFragment(checkInPage, "Check-in");
